...
# Set IP core options
startgroup
set_property -dict [list CONFIG.c_m_axi_mm2s_data_width {32} CONFIG.c_m_axis_mm2s_tdata_width {24} CONFIG.c_num_fstores {2} CONFIG.c_mm2s_genlock_mode {0} CONFIG.c_mm2s_linebuffer_depth {4096} CONFIG.c_mm2s_max_burst_length {32} CONFIG.c_include_s2mm {0} CONFIG.c_s2mm_genlock_mode {0}] [get_bd_cells vga/axi_vdma_0]
...
connect_bd_intf_net [get_bd_intf_pins vga/axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins vga/v_axi4s_vid_out_0/video_in]
